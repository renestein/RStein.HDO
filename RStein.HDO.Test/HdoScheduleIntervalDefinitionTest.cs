...
{
  [TestFixture]
  public class HdoScheduleIntervalDefinitionTest
  {
    ...
    {
      var toCheckDate = new DateTime(2020, 12, 12, hour, minute, 0);
      var schedule = CreateDefaultNonEmptyHdoSchedule(() => toCheckDate);
      var intervalDefinition = schedule.ScheduleIntervalDefinitions.First(definition => definition.ApplyToDayOfWeeks.Contains(toCheckDate.DayOfWeek));
      var isHdoActive = intervalDefinition.IsHdoActive();
